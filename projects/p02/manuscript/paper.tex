...
\textbf{c}, [PLACEHOLDER --- hardcoded data] Preliminary amplitude retention ratio for Kelvin wave events crossing three perturbation zones. Values must be recomputed from the deduped event catalog with proper controls.}
\label{fig:hovmoller}
\end{figure}
